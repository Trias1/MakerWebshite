 ...
 * @see Cart
 */
@Service("test.CartService")
@Validated
@EntityService(entityClass = Cart.class, serviceId = "test")
public class CartServiceImpl implements CartService {
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service test for table Cart to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service test for table Cart to {} format", options.getExportType());
