 ...
 * @see Product
 */
@Service("testing.ProductService")
@Validated
@EntityService(entityClass = Product.class, serviceId = "testing")
public class ProductServiceImpl implements ProductService {
    ...
    @Transactional(value = "testingTransactionManager")
    @Override
    ...
    @Transactional(readOnly = true, value = "testingTransactionManager")
    @Override
    ...
    @Transactional(rollbackFor = EntityNotFoundException.class, value = "testingTransactionManager")
    @Override
    ...
    @Transactional(readOnly = true, value = "testingTransactionManager", timeout = 300)
    @Override
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service testing for table Product to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service testing for table Product to {} format", options.getExportType());
