...
@Service
public class TestingQueryExecutorServiceImpl implements TestingQueryExecutorService {

    private static final Logger LOGGER = LoggerFactory.getLogger(TestingQueryExecutorServiceImpl.class);

    @Autowired
    @Qualifier("testingWMQueryExecutor")
