...
@Service
public class TestingProcedureExecutorServiceImpl implements TestingProcedureExecutorService {

    private static final Logger LOGGER = LoggerFactory.getLogger(TestingProcedureExecutorServiceImpl.class);

    @Autowired
    @Qualifier("testingWMProcedureExecutor")
