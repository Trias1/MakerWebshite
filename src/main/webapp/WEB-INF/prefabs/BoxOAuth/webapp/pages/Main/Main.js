...
Prefab.OauthcallbackGetAccessTokenonSuccess = function(variable, data) {
    var callbackParams;
    if (data && data.value) {
        Prefab.onAccesstokenfetch(null, {
            'accesstoken': data.value
        });
        Prefab.accesstoken = data.value;
        ...
        Prefab.Variables.OauthcallbackGetLoginURL.setInput('state', callbackParams);
        Prefab.Variables.OauthcallbackGetLoginURL.invoke();
    }
};

Prefab.OauthcallbackGetLoginURLonSuccess = function(variable, data) {
